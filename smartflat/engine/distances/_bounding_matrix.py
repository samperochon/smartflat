"""Bounding matrix construction for elastic distance computation.
...
def create_bounding_matrix(
    ...
    np.ndarray of shape (x_size, y_size)
        Bounding matrix where values in bound are True and out of bounds are False.
    """
...
def _sakoe_chiba_bounding(
    ...
    matrix = np.full((x_size, y_size), False)
